...
Page {
    ...
    Connections {
        ...
        onAddScriptReply: function(id, status, scriptId, errors) {
        ...
        onEditScriptReply: function(id, status, errors) {
        ...
        onRenameScriptReply: function(id, status) {
            if (id == d.callId) {
                d.callId = -1;
            }
        }

        onScriptMessage: function(scriptId, type, message) {
